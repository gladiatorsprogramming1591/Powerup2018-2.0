...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1.whileHeld(new bottomElevator());
        ...
        SmartDashboard.putData("topElevator", new topElevator());
        SmartDashboard.putData("midwayElevator", new midwayElevator());
