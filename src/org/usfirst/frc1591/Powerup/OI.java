...
public class OI {
    ...
    public JoystickButton clampOpenButton;
    public JoystickButton clampCloseButton;
    ...
    public OI() {
        ...
        clampCloseButton = new JoystickButton(elevatorStick, 6);
        clampCloseButton.whenPressed(new clampClose());
        clampOpenButton = new JoystickButton(elevatorStick, 5);
        clampOpenButton.whenPressed(new clampOpen());
