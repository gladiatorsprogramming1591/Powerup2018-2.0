...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("autoLeftLL", new autoLeftLL());
        SmartDashboard.putData("autoLeftRR", new autoLeftRR());
        SmartDashboard.putData("autoRightLL", new autoRightLL());
        SmartDashboard.putData("autoRightRR", new autoRightRR());
        SmartDashboard.putData("autoCenterLL", new autoCenterLL());
        SmartDashboard.putData("autoCenterRR", new autoCenterRR());
